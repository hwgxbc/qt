...
{
    ui->lineEditSendContext->setText(ui->lineEdit_2->text());
    on_btnSendContext_clicked();
     ui->checkBHexSend->setChecked(ui->checkBox_2->isChecked());
}


void Widget::on_pushButton_3_clicked()
{
    ui->lineEditSendContext->setText(ui->lineEdit_3->text());
    on_btnSendContext_clicked();
     ui->checkBHexSend->setChecked(ui->checkBox_3->isChecked());
}

void Widget::on_pushButton_4_clicked()
{
    ui->lineEditSendContext->setText(ui->lineEdit_4->text());
    on_btnSendContext_clicked();
     ui->checkBHexSend->setChecked(ui->checkBox_4->isChecked());
}

void Widget::on_pushButton_5_clicked()
{
    ui->lineEditSendContext->setText(ui->lineEdit_5->text());
    on_btnSendContext_clicked();
     ui->checkBHexSend->setChecked(ui->checkBox_5->isChecked());
}

void Widget::on_pushButton_6_clicked()
{
    ui->lineEditSendContext->setText(ui->lineEdit_6->text());
    on_btnSendContext_clicked();
    ui->checkBHexSend->setChecked(ui->checkBox_6->isChecked());
}

void Widget::on_pushButton_7_clicked()
{
    ui->lineEditSendContext->setText(ui->lineEdit_7->text());
    on_btnSendContext_clicked();
    ui->checkBHexSend->setChecked(ui->checkBox_7->isChecked());
}

void Widget::on_pushButton_8_clicked()
{
    ui->lineEditSendContext->setText(ui->lineEdit_8->text());
    on_btnSendContext_clicked();
     ui->checkBHexSend->setChecked(ui->checkBox_7->isChecked());
}
...
{
    ui->lineEditSendContext->setText(ui->lineEdit_9->text());
    on_btnSendContext_clicked();
     ui->checkBHexSend->setChecked(ui->checkBox_7->isChecked());
}
